...
class Simple3Dshapes extends Component {
    ...
    generateQuestion = () => {
        ...
        let questionString = 'What is the ';
        ...
        if (Math.random() < 0.5) { // surface area
            questionString += 'surface area of a ';
            switch (shape) {
                case 'cube': // cube(1~6),
                    a = myMath.randomInteger(1, 6);
                    questionString += 'cube with edge length ' + a;
                    correctAnswer = 6 * a * a + '';
                    hintString = '6a^2';
                    diagram = cube;
                    break;
                case 'cuboid': // cuboid(1~5),
                    ...
                    questionString += 'cuboid (rectangular prism) with dimesions ' + a + ' by ' + b + ' by ' + c;
                ...
                case 'cylinder': // right circular cylinder(r, h = 1~5),
                    ...
                    questionString += 'right circular cylinder with base radius ' + r + ', and height ' + h;
                ...
                case 'coneOrPyramid': // right circular cone(r = 1~5, s = r + 1~5),
                    ...
                    questionString += 'right circular cone with base radius ' + r + ', and slant height ' + s;
                ...
                case 'sphere': // sphere(1~10);
                    ...
                    questionString += 'sphere with radius ' + r;
            ...
            switch (shape) {        
                ...
                case 'cylinder': // cylinder(1~6),
                    ...
                    questionString += 'cylinder with base radius ' + r + ', and height ' + h;
                    correctAnswer = r * r * h;
                ...
                case 'coneOrPyramid': // cone / square pyramid(1~6, or + h*=3), triangular / hexagonal pyramid(A, h = 1~10, A or h *= 3);
                    ...
                    switch (base) {
                        case 'cone':
                            ...
                            h = myMath.randomInteger(1, 6);
                            if (r * h % 3) { h *= 3 };
                            questionString += 'cone with base radius ' + r + ', and height ' + h;
                        ...
                        case 'square':
                            ...
                            h = myMath.randomInteger(1, 6);
                            if (a * h % 3) { h *= 3 };
                            questionString += 'square pyramid with base side length ' + a + ', and height ' + h;
                        ...
                        case 'triangular':
                            ...
                            questionString += 'triangular pyramid with base area ' + A + ', and height ' + h;
                            correctAnswer = A * h / 3 + '';
                        ...
                        case 'hexagonal':
                            ...
                            h = myMath.randomInteger(1, 10);
                            if (A * h % 3) { Math.random() < 0.5 ? h *= 3 : A *= 3 };
                            questionString += 'hexagonal pyramid with base area ' + A + ', and height ' + h;
                            correctAnswer = A * h / 3 + '';
                            hintString = '{1 \\over 3} A h';
        ...
        questionString += '? (If you need to input \u03c0, please type pi or click on the button labelled \u03c0.)'

        return <>
            <p style={{ textAlign: 'left' }}>{questionString}</p>
            <img className='canvas' src={diagram} alt="(No diagram)" width={Math.min(window.innerWidth * 0.5, window.innerHeight * 0.3)} />
        </>;
    }
...
render() {
    ...
    let answerForm = (<>
        Your answer: <input type="text" value={this.state.userAnswer} ref={this.answerForm} autoFocus
            onChange={e => {
