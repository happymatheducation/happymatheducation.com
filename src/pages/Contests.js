...
function Contests() {
  ...
  return (
    ...
    <h1 style = {{color: '#748DA6', fontSize: '40px', textAlign: 'center', marginBottom: '30px'}}>Recommended math contests for students every year, based on grade</h1>
    
    <h1 style = {{color: '#748DA6', fontSize: '40px', textAlign: 'center', marginTop: '20px', marginBottom: '210px'}}>
      {'Select your\u00A0'}
      <div class="dropdown">
